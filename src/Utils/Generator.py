...
def generate_banking_dataset(n):
    ...
    for _ in range(n):
        data = {
            ...
            'Account_Type': random.choice(['Conto Corrente', 'Conto Deposito']),
            ...
            'Employment_Type': random.choice(['Tempo Pieno', 'Tempo Parziale', 'Libero Professionista']),
            'Credit_Score': random.randint(300, 850),
            'Loan_Amount': round(random.uniform(1000, 100000), 2),
            'Loan_Term': random.choice(['None', '12 months', '24 months', '36 months', '60 months', '120 months']),
